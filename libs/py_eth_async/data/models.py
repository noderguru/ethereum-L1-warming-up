...
class Networks:
    ...
    Klaytn = Network(
        name='klaytn',
        rpc='https://klaytn.blockpi.network/v1/rpc/public',  # https://rpc.ankr.com/klaytn
        chain_id=8217,
        tx_type=0,
        coin_symbol='KLAY',
        explorer='https://klaytnscope.com/tx/',
        # api=API(
        #     key=config.KLAYTN_API_KEY, url=..., docs=...,
        # )
    )
    Harmony = Network(
        name='harmony',
        ...
        # api=API(
        #     key=config.HARMONY_API_KEY, url=..., docs=...,
        # )
    )
    Core = Network(
        name='core',
    ...
    Kava = Network(
        ...
        tx_type=0,
        coin_symbol='KAVA',
        explorer='https://kavascan.com/tx',
    )
    Conflux = Network(
        name='conflux',
        rpc='https://evm.confluxrpc.com',  # https://conflux-espace-public.unifra.io
        chain_id=1030,
        tx_type=0,
        coin_symbol='CFX',
    ...
    Astar = Network(
        ...
        tx_type=0,
        coin_symbol='ASTR',
        explorer='https://astar.subscan.io/tx',
    )
    Fuse = Network(
        name='fuse',
    ...
    DFK = Network(
        ...
        tx_type=0,
        coin_symbol='JEWEL',
        explorer='https://explorer.dfkchain.com/',
    )
